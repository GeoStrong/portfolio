...
const Timeline: React.FC = () => {
  const isMobile = typeof window !== "undefined" && window.innerWidth < 376;

  const TimelineWithDirection = isMobile ? TIMELINE.reverse() : TIMELINE;
    ...
    <section id="timeline" className="py-24 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="relative">
          {/* Vertical Line */}
          <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-0.5 bg-linear-to-b from-indigo-500 via-purple-500 to-pink-500" />

          <div className="space-y-12">
            {TimelineWithDirection.slice()
              .reverse()
              .map((event, idx) => {
